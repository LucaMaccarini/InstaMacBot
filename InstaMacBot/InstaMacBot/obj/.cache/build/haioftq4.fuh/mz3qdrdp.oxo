...
<html>
  ...
  <div class="markdown level0 remarks"></div>
    <h3 id="classes">Classes
      ...
      <section><p>the object of this class rapresents a file created from once of the StartStopBot
...
used to store all bot files of the user that is using the bot client and display the list inside a lisatbox
objects of this class are mutable</p>
</section>
      <h4><a class="xref" href="InstaMacBot.classes.BotClient.html">BotClient</a></h4>
      <section><p>the objects of this class are bots manager they contains a map with [name,SSSbot]
are used just to have an organizzation of all bots grouped in a client and with an unique name for bot</p>
      ...
      <section><p>this class rappresents an entity that can override, append or create a file with some text saved in
objects of this class are immuteble</p>
</section>
      <h4><a class="xref" href="InstaMacBot.classes.DesktopTextBoxConsole.html">DesktopTextBoxConsole</a></h4>
      <section><p>this class rappresents a console for desktop client that wraps a textbox
objects of this class are mutable</p>
</section>
      <h4><a class="xref" href="InstaMacBot.classes.FollowLikeLastsPicBot.html">FollowLikeLastsPicBot</a></h4>
      <section><p>this class represents a follow, like lasts pics bot that works with a list of username
...
objects of this class are mutable</p>
      ...
      <section><p>this class represents a screaper bot that extract all accounts that had recently posted a photo tagging a target hastag (limit about 20.000 accounts)
objects of this class are mutable</p>
</section>
      <h4><a class="xref" href="InstaMacBot.classes.ScrapeAccountsFromLocationBot.html">ScrapeAccountsFromLocationBot</a></h4>
      <section><p>this class represents a screaper bot that extract all accounts that had recently posted a photo tagging a target location (limit about 20.000 accounts)
objects of this class are mutable</p>
</section>
      <h4><a class="xref" href="InstaMacBot.classes.ScrapeFollowersBot.html">ScrapeFollowersBot</a></h4>
      <section><p>this class represents a screaper bot that extract all accounts that are following a targhet account (limit about 20.000 accounts)
objects of this class are mutable</p>
</section>
      <h4><a class="xref" href="InstaMacBot.classes.SendDmBot.html">SendDmBot</a></h4>
      <section><p>this class represents a send dms bot that works on a list of username for each username on list sends a dm
objects of this class are mutable</p>
</section>
      <h4><a class="xref" href="InstaMacBot.classes.SSSBot.html">SSSBot</a></h4>
      <section><p>this abstract class define a status bot -&gt; a StartStopBot with status field, so is possible check if is running</p>
</section>
      <h4><a class="xref" href="InstaMacBot.classes.UnfollowBot.html">UnfollowBot</a></h4>
      <section><p>this class represents an unfollow bot that works on a list of username and it unfollows all users on the list
objects of this class are mutable</p>
</section>
      <h4><a class="xref" href="InstaMacBot.classes.UserApi.html">UserApi</a></h4>
      <section><p>this class represents the instagram user and contains the api taken from InstagramApiSharp (github project: <a href="https://github.com/ramtinak/InstagramApiSharp">https://github.com/ramtinak/InstagramApiSharp</a>) 
...
the objects of this class are mutable</p>
    ...
    <h3 id="interfaces">Interfaces
      ...
      <section><p>this interface rappresents a console where is possible write in</p>
</section>
      <h4><a class="xref" href="InstaMacBot.classes.BotFileSaver.html">BotFileSaver</a></h4>
      <section><p>this interface rapresents an entity able to save a list of strings or only a string row in a file</p>
</section>
      <h4><a class="xref" href="InstaMacBot.classes.StartStopBot.html">StartStopBot</a></h4>
      <section><p>this interface define a start stop bot -&gt; a bot that is possible start or stop itself</p>
</section>
</article>
          </div>
