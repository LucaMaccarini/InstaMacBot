...
namespace InstaMacBot.classes
{
    ...
    public class FollowLikeLastsPicBot : SSSBot
    {
        ...
        public FollowLikeLastsPicBot(UserApi Utente, string path_bot_save_info, BotConsole tx_console = null, int stop_fails_search_user = 20, int like_lasts_pic = 1, bool follow_accounts = true, int stop_fails_like = 5, int stop_fails_follow = 5, int delay = 40, Action actions = null) : base(tx_console)
        {
