...
namespace InstaMacBot.classes
{
    ...
    public class SendDmBot : SSSBot
    {
        ...
        public SendDmBot(UserApi Utente, string path_bot_save_info, BotConsole tx_console = null, int stop_fails_search_user = 20, string message = "", string link = "", int stop_fails_send_dm = 5, int delay = 50, Action actions = null) : base(tx_console)
        {
